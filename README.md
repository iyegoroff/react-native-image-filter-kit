...
- iOS & Android:
  ...
  [extracted into temporary files](https://github.com/iyegoroff/react-native-image-filter-kit/tree/master/examples/ImageExtraction#description) of original size
