...
public class RNMainReactPackageWithFrescoCache extends MainReactPackage {

  private @Nullable final Integer mMaxCacheEntries;
  private @Nullable final Integer mMaxCacheSizeInBytes;

  public RNMainReactPackageWithFrescoCache(
  ...
  public List<ModuleSpec> getNativeModules(final ReactApplicationContext context) {
    ...
    final RNBitmapMemoryCacheParamsSupplier cacheParamsSupplier =
      new RNBitmapMemoryCacheParamsSupplier(context, mMaxCacheEntries, mMaxCacheSizeInBytes);
