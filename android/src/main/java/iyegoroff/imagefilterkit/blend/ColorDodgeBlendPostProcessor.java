...
public class ColorDodgeBlendPostProcessor extends RenderscriptCompositionPostProcessor {
  ...
  public ColorDodgeBlendPostProcessor(
    final int width,
    final int height,
  ...
  protected void processRenderscriptComposition(
    ...
    final ScriptC_ColorDodgeBlend script =
      new ScriptC_ColorDodgeBlend(rs, context.getResources(), R.raw.colordodgeblend);
  ...
  public CacheKey generateCacheKey() {
    return compositionCacheKey("color_dodge_blend");
  }
}
