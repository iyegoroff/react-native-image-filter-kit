  ...
  switch (model.tag) {
    ...
    case 25:
      return init_1(ofArray([[new Input(21), function (name_9) {
        return initScalar(1, 50, name_9);
      }], [new Input(22), function (name_10) {
        return initScalar(1, 10, name_10);
      }]]));
    ...
    case 26:
      return init_1(ofArray([[new Input(10), (toDistance = function (arg00) {
        ...
        return initDistance(toDistance, 0, 50, name_11);
      })], [new Input(23), initBoolean]]));

    case 27:
      return init_1(ofArray([[new Input(10), (toDistance_1 = function (arg00_1) {
        return arg00_1 + "max";
      }, function (name_13) {
        return initDistance(toDistance_1, 0, 50, name_13);
      })], [new Input(23), initBoolean]]));
    ...
    case 28:
      return init_1(ofArray([[new Input(10), (toDistance_2 = function (arg00_2) {
        ...
        return initDistance(toDistance_2, 0, 50, name_15);
      })], [new Input(23), initBoolean]]));
    ...
    case 30:
      return init_1(ofArray([[new Input(10), (toDistance_3 = function (arg00_3) {
        ...
        return initDistance(toDistance_3, 0, 50, name_17);
      })], [new Input(1), (max = 2 * 3.141592653589793, function (name_18) {
        return initScalar(0, max, name_18);
      })], [new Input(23), initBoolean]]));

    case 31:
      return init_1(ofArray([[new Input(9), function (name_20) {
        return initScalar(0, 1, name_20);
      }], [new Input(13), function (name_21) {
        return initScalar(0, 1, name_21);
      }]]));

    case 32:
      return init_1(ofArray([[new Input(3), function (name_22) {
        ...
        return initDistance(toDistance_4, 0, 100, name_23);
      })], [new Input(23), initBoolean]]));

    case 33:
      return init_1(ofArray([[new Input(7), function (name_25) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_25);
      }], [new Input(8), function (name_26) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_26);
      }]]));

    case 34:
      return init_1(ofArray([[new Input(11), function (name_27) {
        return initScalar(0, 10, name_27);
      }], [new Input(2), function (name_28) {
        return initScalar(0, 10, name_28);
      }], [new Input(4), function (name_29) {
        return initScalar(0, 10, name_29);
      }]]));

    case 35:
      return init_1(ofArray([[new Input(15), function (name_30) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_30);
      }], [new Input(16), function (name_31) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_31);
      }], [new Input(17), function (name_32) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_32);
      }], [new Input(18), function (name_33) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_33);
      }], [new Input(19), function (name_34) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_34);
      }]]));

    case 36:
      return init_1(ofArray([[new Input(1), (max_1 = 2 * 3.141592653589793, function (name_35) {
        return initScalar(0, max_1, name_35);
      })]]));
    ...
    case 48:
      return init_1(ofArray([[new Input(3), function (name_36) {
        return initPoint(function (tupledArg_1) {
          return toPoint(tupledArg_1[0], tupledArg_1[1]);
        }, 0, 0, 100, 100, name_36);
      }], [new Input(5), function (name_37) {
        return initScalar(0, 1, name_37);
      }], [new Input(10), (toDistance_5 = function (arg00_5) {
        return arg00_5 + "max";
      }, function (name_38) {
        return initDistance(toDistance_5, 0, 100, name_38);
      })]]));
    ...
    case 50:
      return init_1(ofArray([[new Input(6), function (name_39) {
        return initScalar(0, 10, name_39);
      }]]));

    case 51:
      return init_1(ofArray([[new Input(0), function (name_40) {
        return initScalar(-1, 1, name_40);
      }]]));

    case 52:
      return init_1(ofArray([[new Input(3), function (name_41) {
        return initPoint(function (tupledArg_2) {
          return toPoint(tupledArg_2[0], tupledArg_2[1]);
        }, 0, 0, 100, 100, name_41);
      }], [new Input(13), function (name_42) {
        return initScalar(0, 1, name_42);
      }], [new Input(14), (toDistance_6 = function (arg00_6) {
        return arg00_6 + "max";
      }, function (name_43) {
        return initDistance(toDistance_6, 0, 100, name_43);
      })]]));

    case 53:
      return init_1(ofArray([[new Input(3), function (name_44) {
        return initPoint(function (tupledArg_3) {
          return toPoint(tupledArg_3[0], tupledArg_3[1]);
        }, 0, 0, 100, 100, name_44);
      }], [new Input(1), (max_2 = 2 * 3.141592653589793, function (name_45) {
        return initScalar(0, max_2, name_45);
      })], [new Input(13), function (name_46) {
        return initScalar(0, 1, name_46);
      }], [new Input(14), (toDistance_7 = function (arg00_7) {
        return arg00_7 + "max";
      }, function (name_47) {
        return initDistance(toDistance_7, 0, 50, name_47);
      })]]));

    case 54:
      return init_1(ofArray([[new Input(3), function (name_48) {
        ...
        return initDistance(toDistance_8, 0, 100, name_49);
      })], [new Input(12), function (name_50) {
        return initScalar(-2, 2, name_50);
      }], [new Input(23), initBoolean]]));

    case 55:
      return init_1(ofArray([[new Input(3), function (name_52) {
        ...
        return initDistance(toDistance_9, 0, 100, name_53);
      })], [new Input(12), function (name_54) {
        return initScalar(-2, 2, name_54);
      }], [new Input(1), (max_3 = 2 * 3.141592653589793, function (name_55) {
        return initScalar(0, max_3, name_55);
      })]]));
    ...
    case 56:
      return init_1(ofArray([[new Input(3), function (name_56) {
        ...
        return initDistance(toDistance_10, 0, 100, name_57);
      })]]));

    case 57:
      return init_1(ofArray([[new Input(3), function (name_58) {
        ...
        return initDistance(toDistance_11, 0, 100, name_59);
      })], [new Input(1), (max_4 = 2 * 3.141592653589793, function (name_60) {
        return initScalar(0, max_4, name_60);
      })], [new Input(23), initBoolean]]));

    case 58:
      return init_1(ofArray([[new Input(13), function (name_62) {
        return initScalar(0, 100, name_62);
      }]]));
    ...
    case 59:
      return init_1(ofArray([[new Input(10), (toDistance_12 = function (arg00_12) {
        ...
        return initDistance(toDistance_12, 0, 50, name_63);
      })], [new Input(5), function (name_64) {
        return initScalar(0, 10, name_64);
      }]]));
    ...
    case 60:
      return init_1(ofArray([[new Input(10), (toDistance_13 = function (arg00_13) {
        ...
        return initDistance(toDistance_13, 0, 50, name_65);
      })], [new Input(3), function (name_66) {
...
function _ResizeOutput___(_arg1_0, _arg1_1) {
  ...
  const $var1 = _arg1[0].tag === 23 ? _arg1[1].tag === 4 ? [0] : [1] : [1];
...
export function view(_arg1) {
  return CurriedLambda((() => {
    switch (_arg1.tag) {
      ...
      case 24:
        return emptyView(function (props_23, children_23) {
          return createElement(RoundAsCircle, createObj(props_23, 1), ...children_23);
        });

      case 25:
        const mapInput_8 = function (_arg10) {
          const $var10 = _arg10[0].tag === 21 ? _arg10[1].tag === 0 ? [0] : [2] : _arg10[0].tag === 22 ? _arg10[1].tag === 0 ? [1] : [2] : [2];

          switch ($var10[0]) {
            case 0:
              const input_8 = _arg10[1].data;
              return new Props.IterativeBoxBlurProps(1, input_8.Convert(input_8.Value));

            case 1:
              const input_9 = _arg10[1].data;
              return new Props.IterativeBoxBlurProps(2, input_9.Convert(input_9.Value));
        ...
        return function (model_8, content_8) {
          return view_1(function (props_24, children_24) {
            return createElement(IterativeBoxBlur, createObj(props_24, 1), ...children_24);
      ...
      case 26:
        const mapInput_9 = function (_arg11) {
          ...
          if (_arg11[0].tag === 10) {
            if (_arg11[1].tag === 1) {
              ...
              const activePatternResult163950 = _ResizeOutput___(_arg11[0], _arg11[1]);

              if (activePatternResult163950 != null) {
                $var11 = [1, getValue(activePatternResult163950)];
              } else {
                $var11 = [2];
              }
            }
          } else {
            const activePatternResult163951 = _ResizeOutput___(_arg11[0], _arg11[1]);

            if (activePatternResult163951 != null) {
              $var11 = [1, getValue(activePatternResult163951)];
            } else {
              $var11 = [2];
            }
          }
        ...
        return function (model_9, content_9) {
          return view_1(function (props_25, children_25) {
            return createElement(CIBoxBlur, createObj(props_25, 1), ...children_25);
      ...
      case 27:
        const mapInput_10 = function (_arg12) {
          ...
          if (_arg12[0].tag === 10) {
            if (_arg12[1].tag === 1) {
              ...
              const activePatternResult163953 = _ResizeOutput___(_arg12[0], _arg12[1]);

              if (activePatternResult163953 != null) {
                $var12 = [1, getValue(activePatternResult163953)];
              } else {
                $var12 = [2];
              }
            }
          } else {
            const activePatternResult163954 = _ResizeOutput___(_arg12[0], _arg12[1]);

            if (activePatternResult163954 != null) {
              $var12 = [1, getValue(activePatternResult163954)];
            } else {
              $var12 = [2];
            }
          }
        ...
        return function (model_10, content_10) {
          return view_1(function (props_26, children_26) {
            return createElement(CIDiscBlur, createObj(props_26, 1), ...children_26);
      ...
      case 28:
        const mapInput_11 = function (_arg13) {
          ...
          if (_arg13[0].tag === 10) {
            if (_arg13[1].tag === 1) {
              ...
              const activePatternResult163956 = _ResizeOutput___(_arg13[0], _arg13[1]);

              if (activePatternResult163956 != null) {
                $var13 = [1, getValue(activePatternResult163956)];
              } else {
                $var13 = [2];
              }
            }
          } else {
            const activePatternResult163957 = _ResizeOutput___(_arg13[0], _arg13[1]);

            if (activePatternResult163957 != null) {
              $var13 = [1, getValue(activePatternResult163957)];
            } else {
              $var13 = [2];
            }
          }
        ...
        return function (model_11, content_11) {
          return view_1(function (props_27, children_27) {
            return createElement(CIGaussianBlur, createObj(props_27, 1), ...children_27);
          }, mapInput_11, model_11, content_11);
        };

      case 29:
        return emptyView(function (props_28, children_28) {
          return createElement(CIMedianFilter, createObj(props_28, 1), ...children_28);
        });
      ...
      case 30:
        const mapInput_12 = function (_arg14) {
          ...
          if (_arg14[0].tag === 10) {
            if (_arg14[1].tag === 1) {
              ...
              const activePatternResult163959 = _ResizeOutput___(_arg14[0], _arg14[1]);

              if (activePatternResult163959 != null) {
                $var14 = [2, getValue(activePatternResult163959)];
              } else {
                $var14 = [3];
              }
            }
            ...
            if (_arg14[1].tag === 0) {
              ...
              const activePatternResult163960 = _ResizeOutput___(_arg14[0], _arg14[1]);

              if (activePatternResult163960 != null) {
                $var14 = [2, getValue(activePatternResult163960)];
              } else {
                $var14 = [3];
              }
            }
          } else {
            const activePatternResult163961 = _ResizeOutput___(_arg14[0], _arg14[1]);

            if (activePatternResult163961 != null) {
              $var14 = [2, getValue(activePatternResult163961)];
            } else {
              $var14 = [3];
            }
          }
        ...
        return function (model_12, content_12) {
          return view_1(function (props_29, children_29) {
            return createElement(CIMotionBlur, createObj(props_29, 1), ...children_29);
      ...
      case 31:
        const mapInput_13 = function (_arg15) {
          ...
          switch ($var15[0]) {
            case 0:
              ...
              return new Props.CINoiseReductionProps(1, input_10.Convert(input_10.Value));

            case 1:
              const input_11 = _arg15[1].data;
              return new Props.CINoiseReductionProps(2, input_11.Convert(input_11.Value));
        ...
        return function (model_13, content_13) {
          return view_1(function (props_30, children_30) {
            return createElement(CINoiseReduction, createObj(props_30, 1), ...children_30);
      ...
      case 32:
        const mapInput_14 = function (_arg16) {
          ...
          if (_arg16[0].tag === 3) {
            if (_arg16[1].tag === 2) {
              ...
              const activePatternResult163964 = _ResizeOutput___(_arg16[0], _arg16[1]);

              if (activePatternResult163964 != null) {
                $var16 = [2, getValue(activePatternResult163964)];
              } else {
                $var16 = [3];
              }
            }
            ...
            if (_arg16[1].tag === 1) {
              ...
              const activePatternResult163965 = _ResizeOutput___(_arg16[0], _arg16[1]);

              if (activePatternResult163965 != null) {
                $var16 = [2, getValue(activePatternResult163965)];
              } else {
                $var16 = [3];
              }
            }
          } else {
            const activePatternResult163966 = _ResizeOutput___(_arg16[0], _arg16[1]);

            if (activePatternResult163966 != null) {
              $var16 = [2, getValue(activePatternResult163966)];
            } else {
              $var16 = [3];
            }
          }
        ...
        return function (model_14, content_14) {
          return view_1(function (props_31, children_31) {
            return createElement(CIZoomBlur, createObj(props_31, 1), ...children_31);
      ...
      case 33:
        const mapInput_15 = function (_arg17) {
          ...
          switch ($var17[0]) {
            case 0:
              ...
              return new Props.CIColorClampProps(1, input_12.Convert(input_12.Value));

            case 1:
              const input_13 = _arg17[1].data;
              return new Props.CIColorClampProps(2, input_13.Convert(input_13.Value));
        ...
        return function (model_15, content_15) {
          return view_1(function (props_32, children_32) {
            return createElement(CIColorClamp, createObj(props_32, 1), ...children_32);
      ...
      case 34:
        const mapInput_16 = function (_arg18) {
          ...
          switch ($var18[0]) {
            case 0:
              ...
              return new Props.CIColorControlsProps(1, input_14.Convert(input_14.Value));

            case 1:
              const input_15 = _arg18[1].data;
              return new Props.CIColorControlsProps(2, input_15.Convert(input_15.Value));

            case 2:
              const input_16 = _arg18[1].data;
              return new Props.CIColorControlsProps(3, input_16.Convert(input_16.Value));
        ...
        return function (model_16, content_16) {
          return view_1(function (props_33, children_33) {
            return createElement(CIColorControls, createObj(props_33, 1), ...children_33);
      ...
      case 35:
        const mapInput_17 = function (_arg19) {
          ...
          switch ($var19[0]) {
            case 0:
              ...
              return new Props.CIColorMatrixProps(1, input_17.Convert(input_17.Value));

            case 1:
              const input_18 = _arg19[1].data;
              return new Props.CIColorMatrixProps(2, input_18.Convert(input_18.Value));

            case 2:
              const input_19 = _arg19[1].data;
              return new Props.CIColorMatrixProps(3, input_19.Convert(input_19.Value));

            case 3:
              const input_20 = _arg19[1].data;
              return new Props.CIColorMatrixProps(4, input_20.Convert(input_20.Value));

            case 4:
              const input_21 = _arg19[1].data;
              return new Props.CIColorMatrixProps(5, input_21.Convert(input_21.Value));
        ...
        return function (model_17, content_17) {
          return view_1(function (props_34, children_34) {
            return createElement(CIColorMatrix, createObj(props_34, 1), ...children_34);
      ...
      case 36:
        const mapInput_18 = function (_arg20) {
          ...
          switch ($var20[0]) {
            case 0:
              ...
              return new Props.CIHueAdjustProps(1, input_22.Convert(input_22.Value));
        ...
        return function (model_18, content_18) {
          return view_1(function (props_35, children_35) {
            return createElement(CIHueAdjust, createObj(props_35, 1), ...children_35);
          }, mapInput_18, model_18, content_18);
        };

      case 37:
        return emptyView(function (props_36, children_36) {
          return createElement(CIMaskToAlpha, createObj(props_36, 1), ...children_36);
        });

      case 38:
        return emptyView(function (props_37, children_37) {
          return createElement(CIMaximumComponent, createObj(props_37, 1), ...children_37);
        });

      case 39:
        return emptyView(function (props_38, children_38) {
          return createElement(CIMinimumComponent, createObj(props_38, 1), ...children_38);
        });

      case 40:
        return emptyView(function (props_39, children_39) {
          return createElement(CIPhotoEffectChrome, createObj(props_39, 1), ...children_39);
        });

      case 41:
        return emptyView(function (props_40, children_40) {
          return createElement(CIPhotoEffectFade, createObj(props_40, 1), ...children_40);
        });

      case 42:
        return emptyView(function (props_41, children_41) {
          return createElement(CIPhotoEffectInstant, createObj(props_41, 1), ...children_41);
        });

      case 43:
        return emptyView(function (props_42, children_42) {
          return createElement(CIPhotoEffectMono, createObj(props_42, 1), ...children_42);
        });

      case 44:
        return emptyView(function (props_43, children_43) {
          return createElement(CIPhotoEffectNoir, createObj(props_43, 1), ...children_43);
        });

      case 45:
        return emptyView(function (props_44, children_44) {
          return createElement(CIPhotoEffectProcess, createObj(props_44, 1), ...children_44);
        });

      case 46:
        return emptyView(function (props_45, children_45) {
          return createElement(CIPhotoEffectTonal, createObj(props_45, 1), ...children_45);
        });

      case 47:
        return emptyView(function (props_46, children_46) {
          return createElement(CIPhotoEffectTransfer, createObj(props_46, 1), ...children_46);
        });
      ...
      case 48:
        const mapInput_19 = function (_arg21) {
          ...
          switch ($var21[0]) {
            case 0:
              ...
              return new Props.CIVignetteEffectProps(1, input_23.Convert(input_23.Value));

            case 1:
              const input_24 = _arg21[1].data;
              return new Props.CIVignetteEffectProps(2, input_24.Convert(input_24.Value));

            case 2:
              const input_25 = _arg21[1].data;
              return new Props.CIVignetteEffectProps(3, input_25.Convert(input_25.Value));
        ...
        return function (model_19, content_19) {
          return view_1(function (props_47, children_47) {
            return createElement(CIVignetteEffect, createObj(props_47, 1), ...children_47);
          }, mapInput_19, model_19, content_19);
        };

      case 49:
        return emptyView(function (props_48, children_48) {
          return createElement(CIColorInvert, createObj(props_48, 1), ...children_48);
        });
      ...
      case 50:
        const mapInput_20 = function (_arg22) {
          ...
          switch ($var22[0]) {
            case 0:
              const input_26 = _arg22[1].data;
              return new Props.CIColorPosterizeProps(1, input_26.Convert(input_26.Value));
        ...
        return function (model_20, content_20) {
          return view_1(function (props_49, children_49) {
            return createElement(CIColorPosterize, createObj(props_49, 1), ...children_49);
      ...
      case 51:
        const mapInput_21 = function (_arg23) {
          ...
          switch ($var23[0]) {
            case 0:
              ...
              return new Props.CIVibranceProps(1, input_27.Convert(input_27.Value));
        ...
        return function (model_21, content_21) {
          return view_1(function (props_50, children_50) {
            return createElement(CIVibrance, createObj(props_50, 1), ...children_50);
      ...
      case 52:
        const mapInput_22 = function (_arg24) {
          ...
          switch ($var24[0]) {
            case 0:
              ...
              return new Props.CICircularScreenProps(1, input_28.Convert(input_28.Value));

            case 1:
              const input_29 = _arg24[1].data;
              return new Props.CICircularScreenProps(2, input_29.Convert(input_29.Value));

            case 2:
              const input_30 = _arg24[1].data;
              return new Props.CICircularScreenProps(3, input_30.Convert(input_30.Value));
        ...
        return function (model_22, content_22) {
          return view_1(function (props_51, children_51) {
            return createElement(CICircularScreen, createObj(props_51, 1), ...children_51);
      ...
      case 53:
        const mapInput_23 = function (_arg25) {
          ...
          switch ($var25[0]) {
            case 0:
              ...
              return new Props.CIDotScreenProps(1, input_31.Convert(input_31.Value));

            case 1:
              const input_32 = _arg25[1].data;
              return new Props.CIDotScreenProps(2, input_32.Convert(input_32.Value));

            case 2:
              const input_33 = _arg25[1].data;
              return new Props.CIDotScreenProps(3, input_33.Convert(input_33.Value));

            case 3:
              const input_34 = _arg25[1].data;
              return new Props.CIDotScreenProps(4, input_34.Convert(input_34.Value));
        ...
        return function (model_23, content_23) {
          return view_1(function (props_52, children_52) {
            return createElement(CIDotScreen, createObj(props_52, 1), ...children_52);
      ...
      case 54:
        const mapInput_24 = function (_arg26) {
          ...
          if (_arg26[0].tag === 3) {
            if (_arg26[1].tag === 2) {
              ...
              const activePatternResult163977 = _ResizeOutput___(_arg26[0], _arg26[1]);

              if (activePatternResult163977 != null) {
                $var26 = [3, getValue(activePatternResult163977)];
              } else {
                $var26 = [4];
              }
            }
            ...
            if (_arg26[1].tag === 1) {
              ...
              const activePatternResult163978 = _ResizeOutput___(_arg26[0], _arg26[1]);

              if (activePatternResult163978 != null) {
                $var26 = [3, getValue(activePatternResult163978)];
              } else {
                $var26 = [4];
              }
            }
            ...
            if (_arg26[1].tag === 0) {
              ...
              const activePatternResult163979 = _ResizeOutput___(_arg26[0], _arg26[1]);

              if (activePatternResult163979 != null) {
                $var26 = [3, getValue(activePatternResult163979)];
              } else {
                $var26 = [4];
              }
            }
          } else {
            const activePatternResult163980 = _ResizeOutput___(_arg26[0], _arg26[1]);

            if (activePatternResult163980 != null) {
              $var26 = [3, getValue(activePatternResult163980)];
            } else {
              $var26 = [4];
            }
          }
        ...
        return function (model_24, content_24) {
          return view_1(function (props_53, children_53) {
            return createElement(CIBumpDistortion, createObj(props_53, 1), ...children_53);
      ...
      case 55:
        const mapInput_25 = function (_arg27) {
          ...
          switch ($var27[0]) {
            case 0:
              ...
              return new Props.CIBumpDistortionLinearProps(1, input_35.Convert(input_35.Value));

            case 1:
              const input_36 = _arg27[1].data;
              return new Props.CIBumpDistortionLinearProps(2, input_36.Convert(input_36.Value));

            case 2:
              const input_37 = _arg27[1].data;
              return new Props.CIBumpDistortionLinearProps(3, input_37.Convert(input_37.Value));

            case 3:
              const input_38 = _arg27[1].data;
              return new Props.CIBumpDistortionLinearProps(4, input_38.Convert(input_38.Value));
        ...
        return function (model_25, content_25) {
          return view_1(function (props_54, children_54) {
            return createElement(CIBumpDistortionLinear, createObj(props_54, 1), ...children_54);
      ...
      case 56:
        const mapInput_26 = function (_arg28) {
          ...
          switch ($var28[0]) {
            case 0:
              ...
              return new Props.CICircleSplashDistortionProps(1, input_39.Convert(input_39.Value));

            case 1:
              const input_40 = _arg28[1].data;
              return new Props.CICircleSplashDistortionProps(2, input_40.Convert(input_40.Value));
        ...
        return function (model_26, content_26) {
          return view_1(function (props_55, children_55) {
            return createElement(CICircleSplashDistortion, createObj(props_55, 1), ...children_55);
      ...
      case 57:
        const mapInput_27 = function (_arg29) {
          ...
          if (_arg29[0].tag === 3) {
            if (_arg29[1].tag === 2) {
              ...
              const activePatternResult163984 = _ResizeOutput___(_arg29[0], _arg29[1]);

              if (activePatternResult163984 != null) {
                $var29 = [3, getValue(activePatternResult163984)];
              } else {
                $var29 = [4];
              }
            }
            ...
            if (_arg29[1].tag === 1) {
              ...
              const activePatternResult163985 = _ResizeOutput___(_arg29[0], _arg29[1]);

              if (activePatternResult163985 != null) {
                $var29 = [3, getValue(activePatternResult163985)];
              } else {
                $var29 = [4];
              }
            }
            ...
            if (_arg29[1].tag === 0) {
              ...
              const activePatternResult163986 = _ResizeOutput___(_arg29[0], _arg29[1]);

              if (activePatternResult163986 != null) {
                $var29 = [3, getValue(activePatternResult163986)];
              } else {
                $var29 = [4];
              }
            }
          } else {
            const activePatternResult163987 = _ResizeOutput___(_arg29[0], _arg29[1]);

            if (activePatternResult163987 != null) {
              $var29 = [3, getValue(activePatternResult163987)];
            } else {
              $var29 = [4];
            }
          }
        ...
        return function (model_27, content_27) {
          return view_1(function (props_56, children_56) {
            return createElement(CICircularWrap, createObj(props_56, 1), ...children_56);
      ...
      case 58:
        const mapInput_28 = function (_arg30) {
          ...
          switch ($var30[0]) {
            case 0:
              ...
              return new Props.CISharpenLuminanceProps(1, input_41.Convert(input_41.Value));
        ...
        return function (model_28, content_28) {
          return view_1(function (props_57, children_57) {
            return createElement(CISharpenLuminance, createObj(props_57, 1), ...children_57);
      ...
      case 59:
        const mapInput_29 = function (_arg31) {
          ...
          switch ($var31[0]) {
            case 0:
              ...
              return new Props.CIUnsharpMaskProps(1, input_42.Convert(input_42.Value));

            case 1:
              const input_43 = _arg31[1].data;
              return new Props.CIUnsharpMaskProps(2, input_43.Convert(input_43.Value));
        ...
        return function (model_29, content_29) {
          return view_1(function (props_58, children_58) {
            return createElement(CIUnsharpMask, createObj(props_58, 1), ...children_58);
      ...
      case 60:
        const mapInput_30 = function (_arg32) {
          ...
          switch ($var32[0]) {
            case 0:
              ...
              return new Props.CICrystallizeProps(1, input_44.Convert(input_44.Value));

            case 1:
              const input_45 = _arg32[1].data;
              return new Props.CICrystallizeProps(2, input_45.Convert(input_45.Value));
        ...
        return function (model_30, content_30) {
          return view_1(function (props_59, children_59) {
            return createElement(CICrystallize, createObj(props_59, 1), ...children_59);
          }, mapInput_30, model_30, content_30);
        };

      default:
        return emptyView(function (props_60, children_60) {
          return createElement(Normal, createObj(props_60, 1), ...children_60);
        });
    }
  })());
}
export function controls(_arg1) {
  return CurriedLambda((() => {
    switch (_arg1.tag) {
      ...
      case 60:
        const name_60 = name(new Model(60));
        return function (model_59, dispatch_59) {
          return controls_1(name_60, model_59, dispatch_59);
        };

      default:
        const name_61 = name(new Model(0));
        return function (model_60, dispatch_60) {
          return controls_1(name_61, model_60, dispatch_60);
        };
    }
  })());
}
const availableCommonFilters = [new Model(0), new Model(1), new Model(2), new Model(3), new Model(4), new Model(5), new Model(6), new Model(7), new Model(8), new Model(9), new Model(10), new Model(11), new Model(12), new Model(13), new Model(14), new Model(15), new Model(16), new Model(17), new Model(18), new Model(19), new Model(20), new Model(21), new Model(22), new Model(23)];
const availableAndroidFilters = Array.from(concat(ofArray([availableCommonFilters, [new Model(24), new Model(25)]])));
