  ...
  switch (model.tag) {
    ...
    case 24:
      return init_1(ofArray([[new Input(10), (toDistance = function (arg00) {
        ...
        return initDistance(toDistance, 0, 50, name_9);
      })], [new Input(21), initBoolean]]));

    case 25:
      return init_1(ofArray([[new Input(10), (toDistance_1 = function (arg00_1) {
        return arg00_1 + "max";
      }, function (name_11) {
        return initDistance(toDistance_1, 0, 50, name_11);
      })], [new Input(21), initBoolean]]));
    ...
    case 26:
      return init_1(ofArray([[new Input(10), (toDistance_2 = function (arg00_2) {
        ...
        return initDistance(toDistance_2, 0, 50, name_13);
      })], [new Input(21), initBoolean]]));
    ...
    case 28:
      return init_1(ofArray([[new Input(10), (toDistance_3 = function (arg00_3) {
        ...
        return initDistance(toDistance_3, 0, 50, name_15);
      })], [new Input(1), (max = 2 * 3.141592653589793, function (name_16) {
        return initScalar(0, max, name_16);
      })], [new Input(21), initBoolean]]));

    case 29:
      return init_1(ofArray([[new Input(9), function (name_18) {
        return initScalar(0, 1, name_18);
      }], [new Input(13), function (name_19) {
        return initScalar(0, 1, name_19);
      }]]));

    case 30:
      return init_1(ofArray([[new Input(3), function (name_20) {
        ...
        return initDistance(toDistance_4, 0, 100, name_21);
      })], [new Input(21), initBoolean]]));

    case 31:
      return init_1(ofArray([[new Input(7), function (name_23) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_23);
      }], [new Input(8), function (name_24) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_24);
      }]]));

    case 32:
      return init_1(ofArray([[new Input(11), function (name_25) {
        return initScalar(0, 10, name_25);
      }], [new Input(2), function (name_26) {
        return initScalar(0, 10, name_26);
      }], [new Input(4), function (name_27) {
        return initScalar(0, 10, name_27);
      }]]));

    case 33:
      return init_1(ofArray([[new Input(15), function (name_28) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_28);
      }], [new Input(16), function (name_29) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_29);
      }], [new Input(17), function (name_30) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_30);
      }], [new Input(18), function (name_31) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_31);
      }], [new Input(19), function (name_32) {
        return initRGBAVector(0, 0, 0, 0, 1, 1, 1, 1, name_32);
      }]]));

    case 34:
      return init_1(ofArray([[new Input(1), (max_1 = 2 * 3.141592653589793, function (name_33) {
        return initScalar(0, max_1, name_33);
      })]]));
    ...
    case 46:
      return init_1(ofArray([[new Input(3), function (name_34) {
        return initPoint(function (tupledArg_1) {
          return toPoint(tupledArg_1[0], tupledArg_1[1]);
        }, 0, 0, 100, 100, name_34);
      }], [new Input(5), function (name_35) {
        return initScalar(0, 1, name_35);
      }], [new Input(10), (toDistance_5 = function (arg00_5) {
        return arg00_5 + "max";
      }, function (name_36) {
        return initDistance(toDistance_5, 0, 100, name_36);
      })]]));
    ...
    case 48:
      return init_1(ofArray([[new Input(6), function (name_37) {
        return initScalar(0, 10, name_37);
      }]]));

    case 49:
      return init_1(ofArray([[new Input(0), function (name_38) {
        return initScalar(-1, 1, name_38);
      }]]));

    case 50:
      return init_1(ofArray([[new Input(3), function (name_39) {
        return initPoint(function (tupledArg_2) {
          return toPoint(tupledArg_2[0], tupledArg_2[1]);
        }, 0, 0, 100, 100, name_39);
      }], [new Input(13), function (name_40) {
        return initScalar(0, 1, name_40);
      }], [new Input(14), (toDistance_6 = function (arg00_6) {
        return arg00_6 + "max";
      }, function (name_41) {
        return initDistance(toDistance_6, 0, 100, name_41);
      })]]));

    case 51:
      return init_1(ofArray([[new Input(3), function (name_42) {
        return initPoint(function (tupledArg_3) {
          return toPoint(tupledArg_3[0], tupledArg_3[1]);
        }, 0, 0, 100, 100, name_42);
      }], [new Input(1), (max_2 = 2 * 3.141592653589793, function (name_43) {
        return initScalar(0, max_2, name_43);
      })], [new Input(13), function (name_44) {
        return initScalar(0, 1, name_44);
      }], [new Input(14), (toDistance_7 = function (arg00_7) {
        return arg00_7 + "max";
      }, function (name_45) {
        return initDistance(toDistance_7, 0, 50, name_45);
      })]]));

    case 52:
      return init_1(ofArray([[new Input(3), function (name_46) {
        ...
        return initDistance(toDistance_8, 0, 100, name_47);
      })], [new Input(12), function (name_48) {
        return initScalar(-2, 2, name_48);
      }], [new Input(21), initBoolean]]));

    case 53:
      return init_1(ofArray([[new Input(3), function (name_50) {
        ...
        return initDistance(toDistance_9, 0, 100, name_51);
      })], [new Input(12), function (name_52) {
        return initScalar(-2, 2, name_52);
      }], [new Input(1), (max_3 = 2 * 3.141592653589793, function (name_53) {
        return initScalar(0, max_3, name_53);
      })]]));

    case 54:
      return init_1(ofArray([[new Input(3), function (name_54) {
        ...
        return initDistance(toDistance_10, 0, 100, name_55);
      })]]));

    case 55:
      return init_1(ofArray([[new Input(3), function (name_56) {
        ...
        return initDistance(toDistance_11, 0, 100, name_57);
      })], [new Input(1), (max_4 = 2 * 3.141592653589793, function (name_58) {
        return initScalar(0, max_4, name_58);
      })], [new Input(21), initBoolean]]));

    case 56:
      return init_1(ofArray([[new Input(13), function (name_60) {
        return initScalar(0, 100, name_60);
      }]]));
    ...
    case 57:
      return init_1(ofArray([[new Input(10), (toDistance_12 = function (arg00_12) {
        ...
        return initDistance(toDistance_12, 0, 50, name_61);
      })], [new Input(5), function (name_62) {
        return initScalar(0, 10, name_62);
      }]]));
    ...
    case 58:
      return init_1(ofArray([[new Input(10), (toDistance_13 = function (arg00_13) {
        ...
        return initDistance(toDistance_13, 0, 50, name_63);
      })], [new Input(3), function (name_64) {
...
function _ResizeOutput___(_arg1_0, _arg1_1) {
  ...
  const $var1 = _arg1[0].tag === 21 ? _arg1[1].tag === 4 ? [0] : [1] : [1];
    ...
    switch (_arg1.tag) {
      ...
      case 24:
        const mapInput_8 = function (_arg10) {
          ...
          if (_arg10[0].tag === 10) {
            if (_arg10[1].tag === 1) {
              $var10 = [0, _arg10[1].data];
            } else {
              const activePatternResult6043 = _ResizeOutput___(_arg10[0], _arg10[1]);

              if (activePatternResult6043 != null) {
                $var10 = [1, getValue(activePatternResult6043)];
              } else {
                $var10 = [2];
              }
            }
          } else {
            const activePatternResult6044 = _ResizeOutput___(_arg10[0], _arg10[1]);

            if (activePatternResult6044 != null) {
              $var10 = [1, getValue(activePatternResult6044)];
            } else {
              $var10 = [2];
            }
          }
          ...
          switch ($var10[0]) {
            case 0:
              return new Props.CIBoxBlurProps(2, $var10[1].Convert($var10[1].Value));

            case 1:
              return new Props.CIBoxBlurProps(1, $var10[1]);
        ...
        return function (model_8, content_8) {
          return view_1(function (props_23, children_23) {
            return createElement(CIBoxBlur, createObj(props_23, 1), ...children_23);
      ...
      case 25:
        const mapInput_9 = function (_arg11) {
          ...
          if (_arg11[0].tag === 10) {
            if (_arg11[1].tag === 1) {
              ...
              const activePatternResult6046 = _ResizeOutput___(_arg11[0], _arg11[1]);

              if (activePatternResult6046 != null) {
                $var11 = [1, getValue(activePatternResult6046)];
              } else {
                $var11 = [2];
              }
            }
          } else {
            const activePatternResult6047 = _ResizeOutput___(_arg11[0], _arg11[1]);

            if (activePatternResult6047 != null) {
              $var11 = [1, getValue(activePatternResult6047)];
            } else {
              $var11 = [2];
            }
          }
          ...
          switch ($var11[0]) {
            case 0:
              return new Props.CIDiscBlurProps(2, $var11[1].Convert($var11[1].Value));

            case 1:
              return new Props.CIDiscBlurProps(1, $var11[1]);
        ...
        return function (model_9, content_9) {
          return view_1(function (props_24, children_24) {
            return createElement(CIDiscBlur, createObj(props_24, 1), ...children_24);
      ...
      case 26:
        const mapInput_10 = function (_arg12) {
          ...
          if (_arg12[0].tag === 10) {
            if (_arg12[1].tag === 1) {
              ...
              const activePatternResult6049 = _ResizeOutput___(_arg12[0], _arg12[1]);

              if (activePatternResult6049 != null) {
                $var12 = [1, getValue(activePatternResult6049)];
              } else {
                $var12 = [2];
              }
            }
          } else {
            const activePatternResult6050 = _ResizeOutput___(_arg12[0], _arg12[1]);

            if (activePatternResult6050 != null) {
              $var12 = [1, getValue(activePatternResult6050)];
            } else {
              $var12 = [2];
            }
          }
          ...
          switch ($var12[0]) {
            case 0:
              return new Props.CIGaussianBlurProps(2, $var12[1].Convert($var12[1].Value));

            case 1:
              return new Props.CIGaussianBlurProps(1, $var12[1]);
        ...
        return function (model_10, content_10) {
          return view_1(function (props_25, children_25) {
            return createElement(CIGaussianBlur, createObj(props_25, 1), ...children_25);
          }, mapInput_10, model_10, content_10);
        };

      case 27:
        return emptyView(function (props_26, children_26) {
          return createElement(CIMedianFilter, createObj(props_26, 1), ...children_26);
        });
      ...
      case 28:
        const mapInput_11 = function (_arg13) {
          ...
          if (_arg13[0].tag === 10) {
            if (_arg13[1].tag === 1) {
              ...
              const activePatternResult6052 = _ResizeOutput___(_arg13[0], _arg13[1]);

              if (activePatternResult6052 != null) {
                $var13 = [2, getValue(activePatternResult6052)];
              } else {
                $var13 = [3];
              }
            }
          } else if (_arg13[0].tag === 1) {
            if (_arg13[1].tag === 0) {
              $var13 = [1, _arg13[1].data];
            } else {
              const activePatternResult6053 = _ResizeOutput___(_arg13[0], _arg13[1]);

              if (activePatternResult6053 != null) {
                $var13 = [2, getValue(activePatternResult6053)];
              } else {
                $var13 = [3];
              }
            }
          } else {
            const activePatternResult6054 = _ResizeOutput___(_arg13[0], _arg13[1]);

            if (activePatternResult6054 != null) {
              $var13 = [2, getValue(activePatternResult6054)];
            } else {
              $var13 = [3];
            }
          }
          ...
          switch ($var13[0]) {
            case 0:
              return new Props.CIMotionBlurProps(2, $var13[1].Convert($var13[1].Value));

            case 1:
              return new Props.CIMotionBlurProps(3, $var13[1].Convert($var13[1].Value));

            case 2:
              return new Props.CIMotionBlurProps(1, $var13[1]);
        ...
        return function (model_11, content_11) {
          return view_1(function (props_27, children_27) {
            return createElement(CIMotionBlur, createObj(props_27, 1), ...children_27);
          }, mapInput_11, model_11, content_11);
        };

      case 29:
        const mapInput_12 = function (_arg14) {
          const $var14 = _arg14[0].tag === 9 ? _arg14[1].tag === 0 ? [0] : [2] : _arg14[0].tag === 13 ? _arg14[1].tag === 0 ? [1] : [2] : [2];

          switch ($var14[0]) {
            case 0:
              const input_8 = _arg14[1].data;
              return new Props.CINoiseReductionProps(1, input_8.Convert(input_8.Value));

            case 1:
              const input_9 = _arg14[1].data;
              return new Props.CINoiseReductionProps(2, input_9.Convert(input_9.Value));
        ...
        return function (model_12, content_12) {
          return view_1(function (props_28, children_28) {
            return createElement(CINoiseReduction, createObj(props_28, 1), ...children_28);
      ...
      case 30:
        const mapInput_13 = function (_arg15) {
          ...
          if (_arg15[0].tag === 3) {
            if (_arg15[1].tag === 2) {
              $var15 = [0, _arg15[1].data];
            } else {
              const activePatternResult6057 = _ResizeOutput___(_arg15[0], _arg15[1]);

              if (activePatternResult6057 != null) {
                $var15 = [2, getValue(activePatternResult6057)];
              } else {
                $var15 = [3];
              }
            }
          } else if (_arg15[0].tag === 0) {
            if (_arg15[1].tag === 1) {
              $var15 = [1, _arg15[1].data];
            } else {
              const activePatternResult6058 = _ResizeOutput___(_arg15[0], _arg15[1]);

              if (activePatternResult6058 != null) {
                $var15 = [2, getValue(activePatternResult6058)];
              } else {
                $var15 = [3];
              }
            }
          } else {
            const activePatternResult6059 = _ResizeOutput___(_arg15[0], _arg15[1]);

            if (activePatternResult6059 != null) {
              $var15 = [2, getValue(activePatternResult6059)];
            } else {
              $var15 = [3];
            }
          }
          ...
          switch ($var15[0]) {
            case 0:
              return new Props.CIZoomBlurProps(2, $var15[1].Convert($var15[1].Value));

            case 1:
              return new Props.CIZoomBlurProps(3, $var15[1].Convert($var15[1].Value));

            case 2:
              return new Props.CIZoomBlurProps(1, $var15[1]);
        ...
        return function (model_13, content_13) {
          return view_1(function (props_29, children_29) {
            return createElement(CIZoomBlur, createObj(props_29, 1), ...children_29);
          }, mapInput_13, model_13, content_13);
        };

      case 31:
        const mapInput_14 = function (_arg16) {
          const $var16 = _arg16[0].tag === 7 ? _arg16[1].tag === 3 ? [0] : [2] : _arg16[0].tag === 8 ? _arg16[1].tag === 3 ? [1] : [2] : [2];

          switch ($var16[0]) {
            case 0:
              const input_10 = _arg16[1].data;
              return new Props.CIColorClampProps(1, input_10.Convert(input_10.Value));

            case 1:
              const input_11 = _arg16[1].data;
              return new Props.CIColorClampProps(2, input_11.Convert(input_11.Value));
        ...
        return function (model_14, content_14) {
          return view_1(function (props_30, children_30) {
            return createElement(CIColorClamp, createObj(props_30, 1), ...children_30);
          }, mapInput_14, model_14, content_14);
        };

      case 32:
        const mapInput_15 = function (_arg17) {
          const $var17 = _arg17[0].tag === 11 ? _arg17[1].tag === 0 ? [0] : [3] : _arg17[0].tag === 2 ? _arg17[1].tag === 0 ? [1] : [3] : _arg17[0].tag === 4 ? _arg17[1].tag === 0 ? [2] : [3] : [3];

          switch ($var17[0]) {
            case 0:
              const input_12 = _arg17[1].data;
              return new Props.CIColorControlsProps(1, input_12.Convert(input_12.Value));

            case 1:
              const input_13 = _arg17[1].data;
              return new Props.CIColorControlsProps(2, input_13.Convert(input_13.Value));

            case 2:
              const input_14 = _arg17[1].data;
              return new Props.CIColorControlsProps(3, input_14.Convert(input_14.Value));
        ...
        return function (model_15, content_15) {
          return view_1(function (props_31, children_31) {
            return createElement(CIColorControls, createObj(props_31, 1), ...children_31);
          }, mapInput_15, model_15, content_15);
        };

      case 33:
        const mapInput_16 = function (_arg18) {
          const $var18 = _arg18[0].tag === 15 ? _arg18[1].tag === 3 ? [0] : [5] : _arg18[0].tag === 16 ? _arg18[1].tag === 3 ? [1] : [5] : _arg18[0].tag === 17 ? _arg18[1].tag === 3 ? [2] : [5] : _arg18[0].tag === 18 ? _arg18[1].tag === 3 ? [3] : [5] : _arg18[0].tag === 19 ? _arg18[1].tag === 3 ? [4] : [5] : [5];

          switch ($var18[0]) {
            case 0:
              const input_15 = _arg18[1].data;
              return new Props.CIColorMatrixProps(1, input_15.Convert(input_15.Value));

            case 1:
              const input_16 = _arg18[1].data;
              return new Props.CIColorMatrixProps(2, input_16.Convert(input_16.Value));

            case 2:
              const input_17 = _arg18[1].data;
              return new Props.CIColorMatrixProps(3, input_17.Convert(input_17.Value));

            case 3:
              const input_18 = _arg18[1].data;
              return new Props.CIColorMatrixProps(4, input_18.Convert(input_18.Value));

            case 4:
              const input_19 = _arg18[1].data;
              return new Props.CIColorMatrixProps(5, input_19.Convert(input_19.Value));
        ...
        return function (model_16, content_16) {
          return view_1(function (props_32, children_32) {
            return createElement(CIColorMatrix, createObj(props_32, 1), ...children_32);
          }, mapInput_16, model_16, content_16);
        };

      case 34:
        const mapInput_17 = function (_arg19) {
          const $var19 = _arg19[0].tag === 1 ? _arg19[1].tag === 0 ? [0] : [1] : [1];

          switch ($var19[0]) {
            case 0:
              const input_20 = _arg19[1].data;
              return new Props.CIHueAdjustProps(1, input_20.Convert(input_20.Value));
        ...
        return function (model_17, content_17) {
          return view_1(function (props_33, children_33) {
            return createElement(CIHueAdjust, createObj(props_33, 1), ...children_33);
          }, mapInput_17, model_17, content_17);
        };

      case 35:
        return emptyView(function (props_34, children_34) {
          return createElement(CIMaskToAlpha, createObj(props_34, 1), ...children_34);
        });

      case 36:
        return emptyView(function (props_35, children_35) {
          return createElement(CIMaximumComponent, createObj(props_35, 1), ...children_35);
        });

      case 37:
        return emptyView(function (props_36, children_36) {
          return createElement(CIMinimumComponent, createObj(props_36, 1), ...children_36);
        });

      case 38:
        return emptyView(function (props_37, children_37) {
          return createElement(CIPhotoEffectChrome, createObj(props_37, 1), ...children_37);
        });

      case 39:
        return emptyView(function (props_38, children_38) {
          return createElement(CIPhotoEffectFade, createObj(props_38, 1), ...children_38);
        });

      case 40:
        return emptyView(function (props_39, children_39) {
          return createElement(CIPhotoEffectInstant, createObj(props_39, 1), ...children_39);
        });

      case 41:
        return emptyView(function (props_40, children_40) {
          return createElement(CIPhotoEffectMono, createObj(props_40, 1), ...children_40);
        });

      case 42:
        return emptyView(function (props_41, children_41) {
          return createElement(CIPhotoEffectNoir, createObj(props_41, 1), ...children_41);
        });

      case 43:
        return emptyView(function (props_42, children_42) {
          return createElement(CIPhotoEffectProcess, createObj(props_42, 1), ...children_42);
        });

      case 44:
        return emptyView(function (props_43, children_43) {
          return createElement(CIPhotoEffectTonal, createObj(props_43, 1), ...children_43);
        });

      case 45:
        return emptyView(function (props_44, children_44) {
          return createElement(CIPhotoEffectTransfer, createObj(props_44, 1), ...children_44);
        });

      case 46:
        const mapInput_18 = function (_arg20) {
          const $var20 = _arg20[0].tag === 3 ? _arg20[1].tag === 2 ? [0] : [3] : _arg20[0].tag === 5 ? _arg20[1].tag === 0 ? [1] : [3] : _arg20[0].tag === 10 ? _arg20[1].tag === 1 ? [2] : [3] : [3];

          switch ($var20[0]) {
            case 0:
              const input_21 = _arg20[1].data;
              return new Props.CIVignetteEffectProps(1, input_21.Convert(input_21.Value));

            case 1:
              const input_22 = _arg20[1].data;
              return new Props.CIVignetteEffectProps(2, input_22.Convert(input_22.Value));

            case 2:
              const input_23 = _arg20[1].data;
              return new Props.CIVignetteEffectProps(3, input_23.Convert(input_23.Value));
        ...
        return function (model_18, content_18) {
          return view_1(function (props_45, children_45) {
            return createElement(CIVignetteEffect, createObj(props_45, 1), ...children_45);
          }, mapInput_18, model_18, content_18);
        };

      case 47:
        return emptyView(function (props_46, children_46) {
          return createElement(CIColorInvert, createObj(props_46, 1), ...children_46);
        });

      case 48:
        const mapInput_19 = function (_arg21) {
          const $var21 = _arg21[0].tag === 6 ? _arg21[1].tag === 0 ? [0] : [1] : [1];

          switch ($var21[0]) {
            case 0:
              const input_24 = _arg21[1].data;
              return new Props.CIColorPosterizeProps(1, input_24.Convert(input_24.Value));
        ...
        return function (model_19, content_19) {
          return view_1(function (props_47, children_47) {
            return createElement(CIColorPosterize, createObj(props_47, 1), ...children_47);
          }, mapInput_19, model_19, content_19);
        };

      case 49:
        const mapInput_20 = function (_arg22) {
          const $var22 = _arg22[0].tag === 0 ? _arg22[1].tag === 0 ? [0] : [1] : [1];

          switch ($var22[0]) {
            case 0:
              const input_25 = _arg22[1].data;
              return new Props.CIVibranceProps(1, input_25.Convert(input_25.Value));
        ...
        return function (model_20, content_20) {
          return view_1(function (props_48, children_48) {
            return createElement(CIVibrance, createObj(props_48, 1), ...children_48);
          }, mapInput_20, model_20, content_20);
        };

      case 50:
        const mapInput_21 = function (_arg23) {
          const $var23 = _arg23[0].tag === 3 ? _arg23[1].tag === 2 ? [0] : [3] : _arg23[0].tag === 13 ? _arg23[1].tag === 0 ? [1] : [3] : _arg23[0].tag === 14 ? _arg23[1].tag === 1 ? [2] : [3] : [3];

          switch ($var23[0]) {
            case 0:
              const input_26 = _arg23[1].data;
              return new Props.CICircularScreenProps(1, input_26.Convert(input_26.Value));

            case 1:
              const input_27 = _arg23[1].data;
              return new Props.CICircularScreenProps(2, input_27.Convert(input_27.Value));

            case 2:
              const input_28 = _arg23[1].data;
              return new Props.CICircularScreenProps(3, input_28.Convert(input_28.Value));
        ...
        return function (model_21, content_21) {
          return view_1(function (props_49, children_49) {
            return createElement(CICircularScreen, createObj(props_49, 1), ...children_49);
          }, mapInput_21, model_21, content_21);
        };

      case 51:
        const mapInput_22 = function (_arg24) {
          const $var24 = _arg24[0].tag === 3 ? _arg24[1].tag === 2 ? [0] : [4] : _arg24[0].tag === 1 ? _arg24[1].tag === 0 ? [1] : [4] : _arg24[0].tag === 13 ? _arg24[1].tag === 0 ? [2] : [4] : _arg24[0].tag === 14 ? _arg24[1].tag === 1 ? [3] : [4] : [4];

          switch ($var24[0]) {
            case 0:
              const input_29 = _arg24[1].data;
              return new Props.CIDotScreenProps(1, input_29.Convert(input_29.Value));

            case 1:
              const input_30 = _arg24[1].data;
              return new Props.CIDotScreenProps(2, input_30.Convert(input_30.Value));

            case 2:
              const input_31 = _arg24[1].data;
              return new Props.CIDotScreenProps(3, input_31.Convert(input_31.Value));

            case 3:
              const input_32 = _arg24[1].data;
              return new Props.CIDotScreenProps(4, input_32.Convert(input_32.Value));
        ...
        return function (model_22, content_22) {
          return view_1(function (props_50, children_50) {
            return createElement(CIDotScreen, createObj(props_50, 1), ...children_50);
      ...
      case 52:
        const mapInput_23 = function (_arg25) {
          ...
          if (_arg25[0].tag === 3) {
            if (_arg25[1].tag === 2) {
              $var25 = [0, _arg25[1].data];
            } else {
              const activePatternResult6070 = _ResizeOutput___(_arg25[0], _arg25[1]);

              if (activePatternResult6070 != null) {
                $var25 = [3, getValue(activePatternResult6070)];
              } else {
                $var25 = [4];
              }
            }
          } else if (_arg25[0].tag === 10) {
            if (_arg25[1].tag === 1) {
              $var25 = [1, _arg25[1].data];
            } else {
              const activePatternResult6071 = _ResizeOutput___(_arg25[0], _arg25[1]);

              if (activePatternResult6071 != null) {
                $var25 = [3, getValue(activePatternResult6071)];
              } else {
                $var25 = [4];
              }
            }
          } else if (_arg25[0].tag === 12) {
            if (_arg25[1].tag === 0) {
              $var25 = [2, _arg25[1].data];
            } else {
              const activePatternResult6072 = _ResizeOutput___(_arg25[0], _arg25[1]);

              if (activePatternResult6072 != null) {
                $var25 = [3, getValue(activePatternResult6072)];
              } else {
                $var25 = [4];
              }
            }
          } else {
            const activePatternResult6073 = _ResizeOutput___(_arg25[0], _arg25[1]);

            if (activePatternResult6073 != null) {
              $var25 = [3, getValue(activePatternResult6073)];
            } else {
              $var25 = [4];
            }
          }
          ...
          switch ($var25[0]) {
            case 0:
              return new Props.CIBumpDistortionProps(2, $var25[1].Convert($var25[1].Value));

            case 1:
              return new Props.CIBumpDistortionProps(3, $var25[1].Convert($var25[1].Value));

            case 2:
              return new Props.CIBumpDistortionProps(4, $var25[1].Convert($var25[1].Value));

            case 3:
              return new Props.CIBumpDistortionProps(1, $var25[1]);
        ...
        return function (model_23, content_23) {
          return view_1(function (props_51, children_51) {
            return createElement(CIBumpDistortion, createObj(props_51, 1), ...children_51);
          }, mapInput_23, model_23, content_23);
        };

      case 53:
        const mapInput_24 = function (_arg26) {
          const $var26 = _arg26[0].tag === 3 ? _arg26[1].tag === 2 ? [0] : [4] : _arg26[0].tag === 10 ? _arg26[1].tag === 1 ? [1] : [4] : _arg26[0].tag === 12 ? _arg26[1].tag === 0 ? [2] : [4] : _arg26[0].tag === 1 ? _arg26[1].tag === 0 ? [3] : [4] : [4];

          switch ($var26[0]) {
            case 0:
              const input_33 = _arg26[1].data;
              return new Props.CIBumpDistortionLinearProps(1, input_33.Convert(input_33.Value));

            case 1:
              const input_34 = _arg26[1].data;
              return new Props.CIBumpDistortionLinearProps(2, input_34.Convert(input_34.Value));

            case 2:
              const input_35 = _arg26[1].data;
              return new Props.CIBumpDistortionLinearProps(3, input_35.Convert(input_35.Value));

            case 3:
              const input_36 = _arg26[1].data;
              return new Props.CIBumpDistortionLinearProps(4, input_36.Convert(input_36.Value));
        ...
        return function (model_24, content_24) {
          return view_1(function (props_52, children_52) {
            return createElement(CIBumpDistortionLinear, createObj(props_52, 1), ...children_52);
          }, mapInput_24, model_24, content_24);
        };

      case 54:
        const mapInput_25 = function (_arg27) {
          const $var27 = _arg27[0].tag === 3 ? _arg27[1].tag === 2 ? [0] : [2] : _arg27[0].tag === 10 ? _arg27[1].tag === 1 ? [1] : [2] : [2];

          switch ($var27[0]) {
            case 0:
              const input_37 = _arg27[1].data;
              return new Props.CICircleSplashDistortionProps(1, input_37.Convert(input_37.Value));

            case 1:
              const input_38 = _arg27[1].data;
              return new Props.CICircleSplashDistortionProps(2, input_38.Convert(input_38.Value));
        ...
        return function (model_25, content_25) {
          return view_1(function (props_53, children_53) {
            return createElement(CICircleSplashDistortion, createObj(props_53, 1), ...children_53);
      ...
      case 55:
        const mapInput_26 = function (_arg28) {
          ...
          if (_arg28[0].tag === 3) {
            if (_arg28[1].tag === 2) {
              $var28 = [0, _arg28[1].data];
            } else {
              const activePatternResult6077 = _ResizeOutput___(_arg28[0], _arg28[1]);

              if (activePatternResult6077 != null) {
                $var28 = [3, getValue(activePatternResult6077)];
              } else {
                $var28 = [4];
              }
            }
          } else if (_arg28[0].tag === 10) {
            if (_arg28[1].tag === 1) {
              $var28 = [1, _arg28[1].data];
            } else {
              const activePatternResult6078 = _ResizeOutput___(_arg28[0], _arg28[1]);

              if (activePatternResult6078 != null) {
                $var28 = [3, getValue(activePatternResult6078)];
              } else {
                $var28 = [4];
              }
            }
          } else if (_arg28[0].tag === 1) {
            if (_arg28[1].tag === 0) {
              $var28 = [2, _arg28[1].data];
            } else {
              const activePatternResult6079 = _ResizeOutput___(_arg28[0], _arg28[1]);

              if (activePatternResult6079 != null) {
                $var28 = [3, getValue(activePatternResult6079)];
              } else {
                $var28 = [4];
              }
            }
          } else {
            const activePatternResult6080 = _ResizeOutput___(_arg28[0], _arg28[1]);

            if (activePatternResult6080 != null) {
              $var28 = [3, getValue(activePatternResult6080)];
            } else {
              $var28 = [4];
            }
          }
          ...
          switch ($var28[0]) {
            case 0:
              return new Props.CICircularWrapProps(2, $var28[1].Convert($var28[1].Value));

            case 1:
              return new Props.CICircularWrapProps(3, $var28[1].Convert($var28[1].Value));

            case 2:
              return new Props.CICircularWrapProps(4, $var28[1].Convert($var28[1].Value));

            case 3:
              return new Props.CICircularWrapProps(1, $var28[1]);
        ...
        return function (model_26, content_26) {
          return view_1(function (props_54, children_54) {
            return createElement(CICircularWrap, createObj(props_54, 1), ...children_54);
          }, mapInput_26, model_26, content_26);
        };

      case 56:
        const mapInput_27 = function (_arg29) {
          const $var29 = _arg29[0].tag === 13 ? _arg29[1].tag === 0 ? [0] : [1] : [1];

          switch ($var29[0]) {
            case 0:
              const input_39 = _arg29[1].data;
              return new Props.CISharpenLuminanceProps(1, input_39.Convert(input_39.Value));
        ...
        return function (model_27, content_27) {
          return view_1(function (props_55, children_55) {
            return createElement(CISharpenLuminance, createObj(props_55, 1), ...children_55);
          }, mapInput_27, model_27, content_27);
        };

      case 57:
        const mapInput_28 = function (_arg30) {
          const $var30 = _arg30[0].tag === 10 ? _arg30[1].tag === 1 ? [0] : [2] : _arg30[0].tag === 5 ? _arg30[1].tag === 0 ? [1] : [2] : [2];

          switch ($var30[0]) {
            case 0:
              const input_40 = _arg30[1].data;
              return new Props.CIUnsharpMaskProps(1, input_40.Convert(input_40.Value));

            case 1:
              const input_41 = _arg30[1].data;
              return new Props.CIUnsharpMaskProps(2, input_41.Convert(input_41.Value));
        ...
        return function (model_28, content_28) {
          return view_1(function (props_56, children_56) {
            return createElement(CIUnsharpMask, createObj(props_56, 1), ...children_56);
          }, mapInput_28, model_28, content_28);
        };

      case 58:
        const mapInput_29 = function (_arg31) {
          const $var31 = _arg31[0].tag === 10 ? _arg31[1].tag === 1 ? [0] : [2] : _arg31[0].tag === 3 ? _arg31[1].tag === 2 ? [1] : [2] : [2];

          switch ($var31[0]) {
            case 0:
              const input_42 = _arg31[1].data;
              return new Props.CICrystallizeProps(1, input_42.Convert(input_42.Value));

            case 1:
              const input_43 = _arg31[1].data;
              return new Props.CICrystallizeProps(2, input_43.Convert(input_43.Value));
        ...
        return function (model_29, content_29) {
          return view_1(function (props_57, children_57) {
            return createElement(CICrystallize, createObj(props_57, 1), ...children_57);
      ...
      case 59:
        ...
        return function (model_30, content_30) {
          return view_1(function (props_58, children_58) {
            return createElement(AndroidTestFilter, createObj(props_58, 1), ...children_58);
...
const availableAndroidFilters = [new Model(59)];
const availableIosFilters = [new Model(0), new Model(1), new Model(2), new Model(3), new Model(4), new Model(5), new Model(6), new Model(7), new Model(8), new Model(9), new Model(10), new Model(11), new Model(12), new Model(13), new Model(14), new Model(15), new Model(16), new Model(17), new Model(18), new Model(19), new Model(20), new Model(21), new Model(22), new Model(23), new Model(24), new Model(25), new Model(26), new Model(27), new Model(28), new Model(29), new Model(30), new Model(31), new Model(32), new Model(33), new Model(34), new Model(35), new Model(36), new Model(37), new Model(38), new Model(39), new Model(40), new Model(41), new Model(42), new Model(43), new Model(44), new Model(45), new Model(46), new Model(47), new Model(48), new Model(49), new Model(50), new Model(51), new Model(52), new Model(53), new Model(54), new Model(55), new Model(56), new Model(57), new Model(58)];
