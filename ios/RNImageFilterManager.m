...
RCT_EXPORT_VIEW_PROPERTY(inputRadius0, NSString);
RCT_EXPORT_VIEW_PROPERTY(inputRadius1, NSString);
...
RCT_EXPORT_VIEW_PROPERTY(inputColor0, UIColor);
RCT_EXPORT_VIEW_PROPERTY(inputColor1, UIColor);
