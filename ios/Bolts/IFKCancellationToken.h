 ...
 */
typedef void(^IFKCancellationBlock)(void);

/*!
 The consumer view of a CancellationToken.
 Propagates notification that operations should be canceled.
 A IFKCancellationToken has methods to inspect whether the token has been cancelled.
 */
@interface IFKCancellationToken : NSObject
