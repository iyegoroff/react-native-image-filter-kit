...
@interface IFKExecutor ()

@property (nonatomic, copy) void(^block)(void(^block)(void));

@end

@implementation IFKExecutor

#pragma mark - Executor methods

+ (instancetype)defaultExecutor {
    static IFKExecutor *defaultExecutor = NULL;
...
+ (instancetype)immediateExecutor {
    static IFKExecutor *immediateExecutor = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
...
+ (instancetype)mainThreadExecutor {
    static IFKExecutor *mainThreadExecutor = NULL;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
